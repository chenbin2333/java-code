 ...
 */
@FunctionalInterface // 如果接口中只有一个抽象方法，该接口就是函数式接口，函数式接口可以用@FunctionalInterface
public interface IMyInterface {
	/** 全局常量，默认都会有一个public static final修饰成员变量，建议简写。 调用方式：只能是通过: 接口名.常量名; */
	public static final int MAX_VALUE = 2;// 【必须是声明的同时接着赋值】 	命名：全大写用_隔开：MAX_VALUE 
	
	/** 全局常量,【必须是声明的同时接着赋值】 	命名：全大写用_隔开：MAX_VALUE */
	int MIN_VALUE = 1;// 全局常量，默认都会有一个public static final修饰成员变量，建议简写
	
	/**
	 * 抽象方法;
	 */
	void testAbstract();// 前面会有默认的public abstract修饰，建议简写
	...
	public default void testDefault1() {
		System.out.println("testDefault1方法");
	}
	...
	public default void testDefault2() {
		System.out.println("testDefault2方法");
	}
	...
	public static void testStatic1() {
		System.out.println("testStatic1方法....");
	}
	...
	public static void testStatic2() {
		System.out.println("testStatic2方法....");
	}
