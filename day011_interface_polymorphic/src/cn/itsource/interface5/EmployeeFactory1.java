 ...
 */
public class EmployeeFactory1 extends AbstractEmployee implements IWeChat, IAlibaba {

	@Override
	public void aliPay() {
		System.out.println("工厂1支付宝支付。。。。");
	}

	@Override
	public void wechatPay() {
		System.out.println("工厂1微信支付。。。。");
	}

	@Override
	public void work() {
		System.out.println("生产娃娃。。。");
	}
