...
//		 	str += "d";//会创建新对象
		 ...
		 */
		String str1 = "abc";// 表示在常量池中创建了一个长度是3个的char数组
		...
		char[] c = {'a', 'b', 'c', 'd', 'j', 'j'};
		System.out.println(c);// abcdjj 直接打印字符数组就是打印的字符串//調用public void println(char x[])
		System.out.println(c.toString());
		System.out.println("地址：" + c);// 地址：[C@15db9742//調用public void println(String x)
		System.out.println("地址：".toString() + c.toString());// 地址：[C@15db9742//調用public void println(String x)
		
		// 常用方法：
				// 1.char charAt(int index) 返回 char指定索引处index的字符。 不能超过下标范围
				str = "abcefg";
				char charAt = str.charAt(4);
				System.out.println("下标4处的字符：" + charAt);//f
				
				// 2.String concat(String str) 将指定的字符串连接到该字符串的末尾。 相当于：+
				String concat1 = "小老弟";
				String concat2 = concat1.concat("你路走窄了");
				System.out.println(concat2);
				
				String concat = str.concat("大宝剑");
				System.out.println("concat: " + concat);//concat:abcefg大宝剑
				System.out.println("str : " + str);//str : abcefg
				 ...
				 */
				String str5 = "asdfed";
				boolean contains = str5.contains("asd");// 判断当前对象str5是否包含连续的参数asd
				boolean contains2 = str5.contains("jue");
				...
				System.out.println("是否已指定的后缀结尾：" + endsWith);//true
				boolean startsWith = str.startsWith("cka");
				System.out.println("是否已指定的前缀开头： " + startsWith);///true
				...
				str = "abceeeabcdefg";
				char[] dst = new char[4];
				str.getChars(2, 6, dst, 0);//将字符串str中下标2开始到6结束【不包含6】的字符复制到数组dst中，从数组的下标1开始粘贴
				...
				str1 = "ascndabc";
				int indexOf21 = str1.indexOf("abc", 4);
				System.out.println("下标为：" + indexOf21);
				...
				System.out.println("============================================================");
				str1 = "ascndabc";
				int lastIndexOf21 = str1.lastIndexOf("abc");
				System.out.println("下标为：" + indexOf21);
				int lastIndexOf2 = str1.indexOf("abc",4);
				System.out.println("下标：" + indexOf2);
				...
				System.out.println("是否满足:" + matches);//true
